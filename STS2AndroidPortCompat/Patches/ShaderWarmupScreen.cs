...
public class ShaderWarmupScreen : Control
{
    ...
    private void BuildUI()
    {
        ...
        AddChild(new ColorRect
        {
            ...
            AnchorRight = 1f,
            AnchorBottom = 1f,
            Color = new Color(0.08f, 0.11f, 0.18f, 1f),
        ...
        {
            Name = "Panel",
            CustomMinimumSize = new Vector2(Mathf.Clamp(vpSize.X * 0.58f, 720f, 1040f), 260f),
            MouseFilter = MouseFilterEnum.Ignore,
        };
        ...
        _statusLabel.AddThemeFontSizeOverride("font_size", Mathf.RoundToInt(22 * _scale));
        ...
        _progressBar = new ProgressBar
        {
            ...
            Value = 0,
            ShowPercentage = true,
            CustomMinimumSize = new Vector2(620, 26),
            MouseFilter = MouseFilterEnum.Ignore,
        };
        ...
        {
            Text = "Enumerating resources...",
            HorizontalAlignment = HorizontalAlignment.Center,
            Modulate = new Color(0.7f, 0.7f, 0.7f),
            MouseFilter = MouseFilterEnum.Ignore,
        };
        _detailLabel.AddThemeFontSizeOverride("font_size", Mathf.RoundToInt(13 * _scale));
    ...
    private static void RestartApp()
    {
        try
        {
            ...
            wrapper?.Call("restartApp");
        }
        catch (Exception ex)
        {
            PatchHelper.Log($"[ShaderWarmup] Java restartApp bridge failed: {ex.Message}");
        }
    }
